...
router.get('/profile/:id', (req, res) => {
    ...
    const sql = "SELECT i.id,i.name, i.address, i.phone, i.email , i.point, p.position,p.discount FROM users u INNER JOIN infos i ON u.userids = i.id INNER JOIN positions p ON p.id = i.position  WHERE u.userids = ?";
